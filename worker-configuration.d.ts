/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 3b5c5af3ef7d3df34fcc4c5b8028bfeb)
// Runtime types generated with workerd@1.20260617.1 2026-06-20 nodejs_compat
interface __BaseEnv_Env {
	MERLIN_FILES: R2Bucket;
	MERLIN_ACTIVATIONS: R2Bucket;
	merlin_db: D1Database;
	LOGIN_RATE_LIMITER: RateLimit;
	MANIFESTS_RATE_LIMITER: RateLimit;
	ADMIN_RATE_LIMITER: RateLimit;
	ASSETS: Fetcher;
	RYU_API_URL: string;
	MERLIN_WORKER_URL: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "RYU_API_URL" | "MERLIN_WORKER_URL" | "DEPOTBOX_API_KEY" | "RYUU_AUTH_CODE" | "HUBCAP_TOKEN" | "JWT_SECRET" | "SESSION_HASH_SECRET">> {}
}
